...
HD_PWD='C:/Users/sisauto/Desktop/PracticasSEA/Tutorial5/Tutorial5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SemiSumador.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SemiSumador.tcl -notrace
